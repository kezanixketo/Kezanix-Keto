...
function AppContent() {
  ...
  const handleWhatsAppOrder = async () => {
    ...
    try {
      ...
      const message = `*${t.orderNew}*%0A%0A` +
        `*${t.orderProduct}:* ${checkoutProduct.name}%0A` +
        `*${t.orderPrice}:* ${priceStr}%0A%0A` +
        `*${t.orderCustomer}*%0A` +
        `*${t.fullName}:* ${orderForm.fullName}%0A` +
        `*${t.idNumber}:* ${orderForm.idNumber}%0A` +
        `*${t.phone}:* ${orderForm.phone}%0A` +
        `*${t.country}:* ${orderForm.country}%0A` +
        `*${t.city}:* ${orderForm.city}%0A` +
        `*${t.district}:* ${orderForm.district}%0A` +
        `*${t.address}:* ${orderForm.address}%0A` +
        `*${t.notes}:* ${orderForm.notes}%0A%0A` +
        `_${t.orderSentFrom}_`;
    ...
    try {
      ...
      if (error) {
        if (error.message.includes('column') || error.code === '42703') {
          alert('⚠️ Error de base de datos: Faltan las columnas para los documentos en inglés.\n\nPor favor, ejecuta el código SQL que te compartí en el panel de Supabase para activar esta función.');
        } else {
          throw error;
        }
        return;
            ...
            >
              <div className="sticky top-0 bg-white z-10 p-6 border-b border-brand-blue/5 flex justify-between items-center">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h2 className="text-xl font-archivo text-brand-blue leading-none">{t.checkoutTitle}</h2>
                    <p className="text-xs text-brand-dark/40 mt-1 font-medium">{isEnglish && checkoutProduct.name_en ? checkoutProduct.name_en : checkoutProduct.name}</p>
                  </div>
                </div>
                <button 
                  onClick={() => setCheckoutProduct(null)}
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      <label className="text-[10px] font-bold uppercase tracking-wider text-brand-dark/40 ml-2">{t.fullName}</label>
                    ...
                    <div className="space-y-2">
                      <label className="text-[10px] font-bold uppercase tracking-wider text-brand-dark/40 ml-2">{t.idNumber}</label>
                      <div className="relative">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      <label className="text-[10px] font-bold uppercase tracking-wider text-brand-dark/40 ml-2">{t.phone}</label>
                      <div className="relative">
                    ...
                    <div className="space-y-2">
                      <label className="text-[10px] font-bold uppercase tracking-wider text-brand-dark/40 ml-2">{t.country}</label>
                      <div className="relative">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      <label className="text-[10px] font-bold uppercase tracking-wider text-brand-dark/40 ml-2">{t.city}</label>
                      <div className="relative">
                    ...
                    <div className="space-y-2">
                      <label className="text-[10px] font-bold uppercase tracking-wider text-brand-dark/40 ml-2">{t.district}</label>
                      <div className="relative">
                        <MapPin className="absolute left-4 top-1/2 -translate-y-1/2 text-brand-blue/30" size={18} />
                        <input 
                          type="text"
                  ...
                  <div className="space-y-2">
                    <label className="text-[10px] font-bold uppercase tracking-wider text-brand-dark/40 ml-2">{t.address}</label>
                    <textarea 
                      placeholder="..."
                  ...
                  <div className="space-y-2">
                    <label className="text-[10px] font-bold uppercase tracking-wider text-brand-dark/40 ml-2">{t.notes}</label>
                    <input 
                      type="text"
                      placeholder="..."
