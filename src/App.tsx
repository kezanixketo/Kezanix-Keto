        ...
        <main className="pt-20">
          ...
          <section className="relative h-[300px] md:h-[450px] flex items-center justify-center overflow-hidden mb-12">
            ...
            <div className="relative z-10 text-center px-6 max-w-5xl">
              ...
              >
                {(isEnglish && config?.hero_title_en) ? config.hero_title_en : config?.hero_title}
              </motion.h1>
              <p className="text-lg md:text-xl text-white/90 max-w-2xl mx-auto font-medium drop-shadow-lg">
                {(isEnglish && config?.info_text_en) ? config.info_text_en : t.heroSub}
              </p>
            </div>
          </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {sortedProducts.map((product, idx) => (
                ...
                >
                  ...
                  <h3 className="text-2xl text-white mb-2">{(isEnglish && product.name_en) ? product.name_en : product.name}</h3>
                  <p className="text-white/70 text-sm mb-6 line-clamp-2">{(isEnglish && product.description_en) ? product.description_en : product.description}</p>
            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              >
                <h2 className="text-4xl md:text-5xl mb-8 leading-tight">
                  {(isEnglish && config?.info_title_en) ? config.info_title_en : config?.info_title}
                </h2>
                <p className="text-lg text-white/80 mb-10 leading-relaxed">
                  {(isEnglish && config?.info_text_en) ? config.info_text_en : config?.info_text}
                </p>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {((isEnglish && config?.benefits_en && config.benefits_en.length > 0) ? config.benefits_en : (config?.benefits || [])).map((benefit, i) => (
